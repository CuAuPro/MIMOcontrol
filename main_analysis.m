...
integrator1_init = 0; % zacetno stanje integratorja
integrator2_init = 0; % zacetno stanje integratorja
integrator3_init = 0; % zacetno stanje integratorja
...
syms s
G=C*(inv(s*I-A))*B+D;
z1 = roots([-0.0091 -0.0004168 -3.425e-06])
z2 = roots([-0.0092 -0.0003413 -1.38e-06])
